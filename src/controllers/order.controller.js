  ...
  try {
    ...
    try {
      if (orderData.customerEmail) {
        console.log(
          "Updating customer data for email:",
    ...
    if (savedOrder.customerEmail) {
      try {
        ...
        const itemsArray = savedOrder.items || [];
        console.log("Processing", itemsArray.length, "items for email");
        ...
        console.log(
          `Order confirmation email sent to ${savedOrder.customerEmail}`,
          emailResult
        );
        if (emailResult && emailResult.error) {
          console.error("Email sending had an error:", emailResult.error);
        } else {
          console.log(
